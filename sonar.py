...
def drawBoard(board):
    ...
    # print numbers across top of the board.
    ...
    # print tthe numbers across the bottom of the board.
    print()
    print('   ' + ('0123456789' * 6))
    print(tensDigitsLine)

def getRandomChests(numChests):
    chests = []     # (x, y) coordinates
...
def showInstructions():
    ...
    The treasure chests don't move around. Sonar devices can detect treasure chests of up
    to a distance of 9 spaces. Try to collect all 3 chests before running out of sonar
    devices. Good luck!
